export default defineI18nConfig(() => ({
    ...
    messages: {
        ru: {
            ...
            passwordResetting: 'Сброс пароля',
            passwordResettingInstructions: 'На ваш почтовый ящик будет отправлено письмо c инструкциями по сбросу пароля',
            currentPassword: 'Текущий пароль',
            newPassword: 'Новый пароль',
            newPasswordConfirmation: 'Новый пароль ещё раз',
            forgotPassword: 'Я не помню пароль!',
            newPasswordSuccessfullySaved: 'Пароль успешно сохранён!',
            instructionsSentToYourEmail: 'Инструкции отправлены на ваш почтовый ящик!',
            createNewPassword: 'Придумайте новый пароль',
            confirmEmail: 'Подтвердите E-mail',
            confirmEmailInstructions:
                'На ваш почтовый ящик будет отправлено письмо. Перейдите по ссылке, указанной в письме, чтобы подтвердить свой E-mail.',
            verificationMailSent: 'Письмо для подтверждения отправлено на вашу почту',
            emailVerifiedSuccessfully: 'Почта успешно подтверждена!',
        ...
        en: {
            ...
            passwordResettingInstructions: 'An email with password reset instructions will be sent to your mailbox',
            currentPassword: 'Current password',
            newPassword: 'New password',
            newPasswordConfirmation: 'New password again',
            forgotPassword: 'Forgot my password!',
            newPasswordSuccessfullySaved: 'Password was successfully saved!',
            instructionsSentToYourEmail: 'Instructions have been sent to your email!',
            createNewPassword: 'Create a new password',
            confirmEmail: 'Confirm E-mail',
            confirmEmailInstructions: 'An email will be sent to your mailbox. Follow the link in the email to confirm your E-mail.',
            verificationMailSent: 'A confirmation email has been sent to your email',
            emailVerifiedSuccessfully: 'Your email has been successfully confirmed!',
